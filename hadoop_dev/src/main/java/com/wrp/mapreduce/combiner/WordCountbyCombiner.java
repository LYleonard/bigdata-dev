package com.wrp.mapreduce.combiner;

import com.wrp.mapreduce.MyMapper;
import com.wrp.mapreduce.MyReducer;
 ...
 * Version 1.0
 **/
public class WordCountbyCombiner extends Configured implements Tool {
    /**
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(WordCountbyCombiner.class);
        ...
        // 第2步：自定义map逻辑类
        job.setCombinerClass(CombinerUD.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int exitStatusCode = ToolRunner.run(conf, new WordCountbyCombiner(), args);
